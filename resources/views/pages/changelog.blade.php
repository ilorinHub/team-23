               ...
               <div class="card">
                  <div class="card-header">
                     <div class="changelog__title">
                        <span class="v-num">Version 1.4.0</span>
                        <span class="sign">-</span>
                        <span class="rl-date">May 31, 2021</span>
                     </div>
                  ...
                  <div class="card-body p-30">
                     <div class="version-list">
                        <div class="version-list__single">
                           ...
                           <ul class="version-primary">
                              <li>Social Media Dashboard Charts</li>
                              <li>Facebook Overview</li>
                              <li>Social Traffics Metrics</li>
                              <li>Email</li>
                              <li>Gallery</li>
                              <li>Contact Grid</li>
                              <li>Contact List</li>
                              <li>Users Grid</li>
                              <li>Users Grid Style</li>
                              <li>Users Group</li>
                              <li>Users List</li>
                              <li>Users List Data Table</li>
                              <li>User Teams</li>
                              <li>Custom Pagination</li>
                              <li>Laravel Crud Inside Use Ajax Data Table</li>
                           </ul>
                        </div>
                     </div>
                     <div class="changelog__according">
                        <div class="changelog__accordingWrapper">
                           <div id="accordion">
                              <div class="card">
                                 <div class="card-header w-100 px-sm-30 px-15" id="headingthree">
                                    <div role="button" class="w-100 changelog__accordingCollapsed collapsed" data-toggle="collapse" data-target="#headingthree" aria-expanded="true" aria-controls="headingthree">
                                       <div class="changelog__accordingTitle d-flex justify-content-between w-100">
                                          <div class="v-num">Version 1.3.0<span class="v-arrow">-</span> <span class="rl-date"> Apr 11, 2021</span></div>
                              ...
                              <div class="card">
                                 <div class="card-header w-100 px-sm-30 px-15" id="headingfour">
                                    <div role="button" class="w-100 changelog__accordingCollapsed collapsed" data-toggle="collapse" data-target="#collapsefour" aria-expanded="true" aria-controls="collapsefour">
                                       <div class="changelog__accordingTitle d-flex justify-content-between w-100">
                                          <div class="v-num">Version 1.2.0<span class="v-arrow">-</span> <span class="rl-date">Mar 23, 2021</span></div>
                                          <div class="changelog__accordingArrow">
                                             <span data-feather="chevron-right"></span>
                                          </div>
                                       </div>
                              ...
                              <div class="card">
                                 <div class="card-header w-100 px-sm-30 px-15" id="headingfive">
                                    <div role="button" class="w-100 changelog__accordingCollapsed collapsed" data-toggle="collapse" data-target="#collapsefive" aria-expanded="true" aria-controls="collapsefive">
                                       <div class="changelog__accordingTitle d-flex justify-content-between w-100">
                                          <div class="v-num">Version 1.0.0<span class="v-arrow">-</span> <span class="rl-date">Feb 14,
                                             2021</span>
                                          </div>
                                          <div class="changelog__accordingArrow">
                                             <span data-feather="chevron-right"></span>
                              ...
                              <div class="card">
                                 <div class="card-header w-100 px-sm-30 px-15" id="headingsix">
                                    <div role="button" class="w-100 changelog__accordingCollapsed collapsed" data-toggle="collapse" data-target="#collapsesix" aria-expanded="true" aria-controls="collapsesix">
                                       <div class="changelog__accordingTitle d-flex justify-content-between w-100">
                                          <div class="v-num">Version 1.1.0<span class="v-arrow">-</span> <span class="rl-date">Jan 20, 2021</span></div>
                                          <div class="changelog__accordingArrow">
                                             <span data-feather="chevron-right"></span>
                                          </div>
                                       </div>
               ...
               <div class="card">
                  ...
                  <div class="card-body p-25">
                     ...
                     <ul class="v-history-list">
                        <li><span class="version-name">Version 1.4.0</span><span class="version-date">May 31,
                           2021</span>
                        </li>
                        <li><span class="version-name">Version 1.3.0</span><span class="version-date">Apr 11,
                           2021</span>
                        </li>
