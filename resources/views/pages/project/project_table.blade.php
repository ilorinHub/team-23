                  ...
                  <div class="project-icon-selected">
                     <div class="listing-social-link pb-lg-0 pb-xs-2">
                        <div class="icon-list-social d-flex">
                           <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center ml-xl-20 mr-20 " href="{{ route('projects.index') }}"><span data-feather="grid"></span></a>
