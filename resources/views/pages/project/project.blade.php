                            ...
                            <ul class="nav px-1" id="ap-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="timeline-tab" data-toggle="pill" href="#timeline" role="tab"
                                        aria-controls="timeline" aria-selected="false">in progress</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="activity-tab" data-toggle="pill" href="#activity" role="tab"
                                        aria-controls="activity" aria-selected="false">completed</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="late-tab" data-toggle="pill" href="#late" role="tab"
                                        aria-controls="late" aria-selected="false">late</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="early-tab" data-toggle="pill" href="#early" role="tab"
                                        aria-controls="early" aria-selected="false">early</a>
                                </li>
                            </ul>
                        </div>
                        <div
                            class="project-search project-search--height global-shadow ml-md-20 my-10 order-md-2 order-1">
                            ...
                            <div class="listing-social-link pb-lg-0 pb-xs-2">
                                <div class="icon-list-social d-flex">
                                    ...
                                    <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center "
                                        href="{{ route('projects.project_table') }}">
                            ...
                            <div class="user-group radius-xl bg-white media-ui media-ui--early pt-30 pb-25">
                                <div class="border-bottom px-30">
                                    <div class="media user-group-media d-flex justify-content-between">
                                        <div
                                            ...
                                            <a href="{{ route("projects.details") }}">
                                                <h6 class="mt-0  fw-500 mr-10">Dashboard UI Project</h6>
                                            </a>
                                            <span
                                    ...
                                    <div class="user-group-people mt-15 text-capitalize">
                                        <p>Lorem ipsum dolor amet, consetetur sadipscing elitr sed diam nonumy eirmod
                                            dolor ame.</p>
                                ...
                                <div class="mt-20 px-30">
                                    ...
                                    <ul class="d-flex flex-wrap user-group-people__parent">
                                        ...
                                        <li>
                                            <a href="#"><img class="rounded-circle wh-34 bg-opacity-secondary"
                                                    src="{{ asset('img/tm6.png') }}" alt="author"></a>
                                        </li>
                                        <li>
                                            <a href="#"><img class="rounded-circle wh-34 bg-opacity-secondary"
                                                    src="{{ asset('img/tm1.png') }}" alt="author"></a>
                                ...
                                <div class="border-bottom px-30">
                                    <div class="media user-group-media d-flex justify-content-between">
                                        <div
                                            class="media-body d-flex align-items-center flex-wrap text-capitalize my-sm-0 my-n2">
                                            <a href="{{ route("projects.details") }}">
                                                <h6 class="mt-0  fw-500 mr-10">Application UI Design</h6>
                                            </a>
                                            <span
                                ...
                                <div class="border-bottom px-30">
                                    <div class="media user-group-media d-flex justify-content-between">
                                        <div
                                            class="media-body d-flex align-items-center flex-wrap text-capitalize my-sm-0 my-n2">
                                            <a href="{{ route("projects.details") }}">
                                                <h6 class="mt-0  fw-500 mr-10">Custom Software Development</h6>
                                            </a>
                                            <span
                                ...
                                <div class="border-bottom px-30">
                                    ...
                                    <div class="user-group-progress-bar">
                                        <div class="progress-wrap d-flex align-items-center mb-0">
                                            ...
                                            <span class="progress-icon"><span class="color-success"
                                                    data-feather="check"></span></span>
                                        </div>
                                        <p class="color-light fs-12 mb-20">12 / 15 tasks completed</p>
                                    </div>
                                </div>
                                ...
                                <div class="border-bottom px-30">
                                    <div class="media user-group-media d-flex justify-content-between">
                                        <div
                                            ...
                                            <span
                                                class="my-sm-0 my-2 media-badge text-uppercase color-white bg-secondary">early</span>
                                        </div>
                                        <div class="mt-n15">
                                            <div class="dropdown dropleft">
                                                <button class="btn-link border-0 bg-transparent p-0"
                                ...
                                <div class="border-bottom px-30">
                                    <div class="media user-group-media d-flex justify-content-between">
                                        <div
                                            class="media-body d-flex align-items-center flex-wrap text-capitalize my-sm-0 my-n2">
                                            <a href="{{ route("projects.details") }}">
                                                <h6 class="mt-0  fw-500 mr-10">Dashboard UI</h6>
                                            </a>
                                            <span
                                                class="my-sm-0 my-2 media-badge text-uppercase color-white bg-primary">early</span>
                                        </div>
