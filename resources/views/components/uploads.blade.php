                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb-main">
                            <h4 class="text-capitalize breadcrumb-title">Upload</h4>
                                ...
                                <div class="atbd-tag-wrap">
                                    <div class="atbd-upload">
                                        <div class="atbd-upload-avatar">
                                            <img class="avatrSrc" src="{{ asset('img/upload.png') }}" alt="Avatar Upload">
                                        </div>
                                        <div class="avatar-up">
                        ...
                        <div class="card card-default card-md mb-4">
                            ...
                            <div class="card-body">
                                <div class="atbd-tag-wrap">
                                    <div class="atbd-upload">
                                        <div class="atbd-upload__button">
                                            <a href="javascript:void(0)" class="btn btn-lg btn-outline-lighten btn-upload" onclick="$('#upload-3').click()"> <span data-feather="upload"></span> Upload</a>
