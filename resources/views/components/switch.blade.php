                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb-main">
                            <h4 class="text-capitalize breadcrumb-title">Switch</h4>
                        ...
                        <div class="card card-default card-md mb-4">
                            ...
                            <div class="card-body">
                                <div class="atbd-switch-wrap d-flex align-items-center">
                                    <div class="custom-control custom-switch switch-primary switch-md ">
                                        <input type="checkbox" class="custom-control-input" id="switch-s2" checked>
                                        <label class="custom-control-label" for="switch-s2"></label>
                                    </div>
                                    <div class="custom-control custom-switch switch-primary switch-sm ">
                                        <input type="checkbox" class="custom-control-input" id="switch-s3" checked>
