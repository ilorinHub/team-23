      ...
      <ul>
            ...
            <ul class="subMenu">
               ...
               <li>
                  <a class="{{ Route::is('dashboards.crm') ? 'active' : ''}}"
                     href="{{ route('dashboards.crm') }}">CRM</a>
               </li>
               <li>
                  <a class="{{ Route::is('dashboards.sales') ? 'active' : ''}}"
                     href="{{ route('dashboards.sales') }}">Sales Performance</a>
               </li>
            </ul>
         </li>
         <li class="has-subMenu">
         ...
         <li class="has-subMenu">
            ...
            <ul class="subMenu">
               ...
               <li class="has-subMenu-left {{ request()->is('applications/email/*') ? 'open' : ''}}">
               ...
               <li class="has-subMenu-left {{ request()->is('applications/ecommerce/*') ? 'open' : ''}}">
               ...
               <li class="has-subMenu-left {{ request()->is('applications/social-app/*') ? 'open' : ''}}">
               ...
               <li class="has-subMenu-left {{ request()->is('projects/*') ? 'open' : ''}}">
               ...
               <li class="has-subMenu-left {{ request()->is('applications/users/*') ? 'open' : ''}}">
                  ...
                  <ul class="subMenu">
                     ...
                     <li>
                        <a class="{{ Route::is('applications.users.usersGrid')  ? 'active' : '' }}"
                           href="{{ route('applications.users.usersGrid') }}">Users Grid</a>
                     </li>
                     <li>
                     ...
                     <li>
                        <a class="{{ Route::is('applications.users.addUser')  ? 'active' : '' }}"
                           href="{{ route('applications.users.addUser') }}">Add User</a>
                     </li>
                     <li>
               ...
               <li class="has-subMenu-left {{ request()->is('applications/contact/*') ? 'open' : ''}}">
                  ...
                  <ul class="subMenu">
                     ...
                     <li>
                        <a class="{{ Route::is('applications.contactCreate')  ? 'active': '' }}"
                           href="{{ route('applications.contactCreate') }}">Contact Create</a>
                     </li>
                  </ul>
               </li>
               <li>
               ...
               <li class="has-subMenu-left {{ request()->is('applications/import-export*') ? 'open' : ''}}">
               ...
               <li class="has-subMenu-left {{ request()->is('firestore*') ? 'open' : ''}}">
         ...
         <li class="has-subMenu">
            ...
            <ul class="subMenu">
                  ...
                  <ul class="subMenu">
                     ...
                     <li>
                        <a class="{{ Route::is('forms.layouts') ? 'active' : '' }}"
                           href="{{ route('forms.layouts') }}">Layouts</a>
                     </li>
                     <li>
                        <a class="{{ Route::is('forms.elements') ? 'active' : '' }}"
                           href="{{ route('forms.elements') }}">Elements</a>
                     </li>
                     <li>
                        <a class="{{ Route::is('forms.components') ? 'active' : '' }}"
                           href="{{ route('forms.components') }}">Components</a>
                     </li>
                     <li>
                        <a class="{{ Route::is('forms.validations') ? 'active' : '' }}"
                           href="{{ route('forms.validations') }}">Validations</a>
                     </li>
                  </ul>
               </li>
               <li class="has-subMenu-left">
               ...
               <li class="has-subMenu-left {{ request()->is('pages/table/*') ? 'open' : ''}}">
               ...
               <li class="has-subMenu-left {{ request()->is('widget/*') ? 'open' : ''}}">
               ...
               <li class="has-subMenu-left {{ request()->is('wizard/*') ? 'open' : ''}}">
         ...
         <li class="has-subMenu">
            ...
            <ul class="subMenu">
               ...
               <li class="has-subMenu-left {{ request()->is('pages/knowledgebase/*') ? 'open' : ''}}">
